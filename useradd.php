<html>
    ...
    <form method="POST" action="new.php">
		...
		<br>
		<input type="text" name="b" size="30" placeholder=" Enter username"><br><br>
        ...
        <br>
        <input type="password" name="e" size="30" placeholder="Enter password"><br>
        <br>
        <input type="password" name="f" size="30" placeholder="Retype your password"><br>
